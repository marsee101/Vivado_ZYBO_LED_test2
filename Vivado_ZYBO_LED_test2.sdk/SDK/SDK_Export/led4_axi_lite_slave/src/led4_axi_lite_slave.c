	...
	while(1){
		...
		switch(inbyte_in) {
			case '1' : // Show all registers
				val = (int)Xil_In32((u32)XPAR_LED4_AXI_LITE_SLAVE_0_BASEADDR);
				printf("Command Register is %x\r\n", val);
				val = (int)Xil_In32((u32)(XPAR_LED4_AXI_LITE_SLAVE_0_BASEADDR+4));
				printf("LED Counter Load Register is %x\r\n", val);
				val = (int)Xil_In32((u32)(XPAR_LED4_AXI_LITE_SLAVE_0_BASEADDR+8));
				printf("LED Monitor Register is %x\r\n", val);
				val = (int)Xil_In32((u32)(XPAR_LED4_AXI_LITE_SLAVE_0_BASEADDR+0xc));
				printf("LED Interval Register is %d (decimal)\r\n", val);
				break;
			case '2' : // Set LED4 Enable or Disable(Toggle, Command Register)
				val = (int)Xil_In32((u32)XPAR_LED4_AXI_LITE_SLAVE_0_BASEADDR);
				if (val & 1) {
					Xil_Out32((u32)XPAR_LED4_AXI_LITE_SLAVE_0_BASEADDR, (u32)0);
					print("LED4 count is Disable\n\r");
				} else {
					Xil_Out32((u32)XPAR_LED4_AXI_LITE_SLAVE_0_BASEADDR, (u32)1);
			...
			case '3' : // Set LED Counter Load Register (4bits, Please input hexadecimal)
				...
				scanf("%x", &val);
				Xil_Out32((u32)(XPAR_LED4_AXI_LITE_SLAVE_0_BASEADDR+4), (u32)val);
				print(" \r\n");
				break;
			case '4' : // Set LED Interval Register (32bits, Please input hexadecimal)
				...
				scanf("%d", &val);
				Xil_Out32((u32)(XPAR_LED4_AXI_LITE_SLAVE_0_BASEADDR+0xc), (u32)val);
				print(" \r\n");
				break;
			case '5' : // exit
				print("exit\r\n");
